...
//  call API from beck-end to pass in idUser using POST Method and MAP to finduserbyid
// addpost and adduser API
...
//          create a
                  postController.unshift(itemObj);
            });
...
//userName and userImgURL are hard-coded at the moment.
//let userName = "Ting";

   let display = "";
   for (let i = 0; i < postController.length; i++ ) {
    console.log("Hello World");
    console.log("all user " + userDetails );
    console.log(postController[i].idUsers);
   //to get the user name and images for display
   let user = userDetails.findIndex(user => { return user.idUsers == postController[i].idUsers});
       ...
       <div class="posting padLeft30 padTop20 ">
        <div class="card-group row col-2 col-sm-2">
            <div class="card text-center " style="width: 18rem;">
                <img id="postImg"  src="http://www.jennybeaumont.com/wp-content/uploads/2015/03/placeholder.gif" alt="">
                <div class="card-body">
                    <h5 id="postUsername" class="card-title">${userName}</h5>
        ...
        <div class=" card-group row col-10 col-sm-10 align-right h-100 d-inline-block">
            <div class="postgroup">
                <ul class="list-group">
                    <li id="postdate" class="list-group-item">${postController[i].postDate}</li>
                    <!-- <li class="list-group-item"> -->

                  <p id="postContent" class="form-control" aria-label="With textarea">${postController[i]
                  .content}</p>
...
function addPost(content, postDate, idTopic, idUsers)
{
